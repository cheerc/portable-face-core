...
2. D1 選型凍結（PR #43 `58991d8`）已 merge，operator 決策 `d-20260914110757304910-5` 已授權開工 T1–T8。T1 研究契約與版本化 profile 已完成交付。下一步為 T2 decoded-frame 單幀管線與固定 gallery。
